...
public class DistribuidoraTest {
	...
	public void setUp() {
		...
		alto = new Consumo(LocalDate.of(2021, 6, 8), 5000d, 2500d);
		bajo = new Consumo(LocalDate.of(2021, 6, 10), 300d, 300d);
		medio = new Consumo(LocalDate.of(2021, 6, 15), 100d, 800d);
	...
	public void testConsumoTotalDeLaRed() {
		...
		Consumo otro = new Consumo(LocalDate.of(2021, 7, 15), 100d, 800d);
